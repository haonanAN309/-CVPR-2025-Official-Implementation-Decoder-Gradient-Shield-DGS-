...
parser.add_argument('--trainpics', default='output_l2_with_consist_loss/',
                    help='folder to output training images')
parser.add_argument('--validationpics', default='output_l2_with_consist_loss/',
                    help='folder to output validation images')
parser.add_argument('--testPics', default='output_l2_with_consist_loss/',
                    help='folder to output test images')
parser.add_argument('--runfolder', default='output_l2_with_consist_loss/',
                    help='folder to output test images')
parser.add_argument('--outckpts', default='output_l2_with_consist_loss/',
                    help='folder to output checkpoints')
parser.add_argument('--outlogs', default='output_l2_with_consist_loss/',
                    help='folder to output images')
parser.add_argument('--outcodes', default='output_l2_with_consist_loss/',
...
def train(train_loader, epoch, Remover, Hnet, Enet):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        diag_elements = 0.001 + (torch.rand(H) * 0.009)
