...
parser.add_argument('--trainpics', default='output_style_l2/',
                    help='folder to output training images')
parser.add_argument('--validationpics', default='output_style_l2/',
                    help='folder to output validation images')
parser.add_argument('--testPics', default='output_style_l2/',
                    help='folder to output test images')
parser.add_argument('--runfolder', default='output_style_l2/',
                    help='folder to output test images')
parser.add_argument('--outckpts', default='output_style_l2/',
                    help='folder to output checkpoints')
parser.add_argument('--outlogs', default='output_style_l2/',
                    help='folder to output images')
parser.add_argument('--outcodes', default='output_style_l2/',
...
def validation(val_loader, epoch, Remover, Hnet, Enet):
    ...
    with torch.no_grad():
        ...
        # print("-------------count: ", count)
        # print("---------------------average runtime: ", total_run_time/count)
