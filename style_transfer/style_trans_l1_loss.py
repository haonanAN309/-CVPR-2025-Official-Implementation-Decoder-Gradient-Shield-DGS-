...
parser.add_argument('--trainpics', default='output_style_l1/',
                    help='folder to output training images')
parser.add_argument('--validationpics', default='output_style_l1/',
                    help='folder to output validation images')
parser.add_argument('--testPics', default='output_style_l1/',
                    help='folder to output test images')
parser.add_argument('--runfolder', default='output_style_l1/',
                    help='folder to output test images')
parser.add_argument('--outckpts', default='output_style_l1/',
                    help='folder to output checkpoints')
parser.add_argument('--outlogs', default='output_style_l1/',
                    help='folder to output images')
parser.add_argument('--outcodes', default='output_style_l1/',
...
def train(train_loader, epoch, Remover, Hnet, Enet):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        err_mse = criterion_pixelwise(trans_rev_secret_img, clean_imgv)
        # err_consist = opt.betamse * criterion_pixelwise(trans_rev_secret_img[0:half_batchsize, :, :, :],
